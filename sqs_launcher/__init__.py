...
class SqsLauncher(object):
    ...
    def __init__(self, queue=None, queue_url=None, create_queue=False, visibility_timeout='600', region_name="us-east-1"):
        """
        ...
        self._client = self._session.client('sqs', region_name=region_name)
